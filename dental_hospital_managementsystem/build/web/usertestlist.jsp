<%-- 
    Document   : usertestlist
    Created on : 10 Feb, 2024, 9:44:14 PM
    Author     : om
--%>
...
<html>
    ...
    <body>
        ...
        <div class="container">
             <form action="Ad_test.jsp" method="post">
            <h1><b>Tests</b></h1>
  ...
  <tbody>
        ...
        try
        {
          ...
          String sql="select * from admin_addtest_tbl where  patname='"+session.getAttribute("uname")+"'";
